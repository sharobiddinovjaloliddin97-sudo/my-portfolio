...
async function initDatabase() {
  ...
  // Check if projects exist, if not seed defaults
    ...
    const defaultProjects = [
      {
        ...
        tags: JSON.stringify(["React", "TypeScript", "Node.js", "Python", "WebSockets", "Chart.js"]),
      ...
      },
      {
        ...
        tags: JSON.stringify(["JavaScript", "Three.js", "WebGL", "CSS3 Glass", "Stripe API"]),
      ...
      },
      {
        ...
        tags: JSON.stringify(["React", "Next.js", "Web3.js", "PostgreSQL", "TailwindCSS", "ApexCharts"]),
      ...
      },
      {
        ...
        tags: JSON.stringify(["Go", "Kubernetes", "Docker", "Prometheus", "GraphQL", "Helm"]),
      ...
      },
      {
        ...
        tags: JSON.stringify(["Rust", "WebAssembly", "Node.js", "CLI", "V8 Engine"]),
      ...
      },
      {
        ...
        tags: JSON.stringify(["React Native", "TypeScript", "Expo", "HealthKit", "SQLite"]),
